...
switch(_type) do
{
	...
	case "1213": {_type = ["20 Km/h Geschwindigkeitsübertretung", 500]};
	case "1214": {_type = ["50 Km/h Geschwindigkeitsübertretung", 1000]};
	case "1215": {_type = ["Über 51 Km/h über dem Geschwindigkeitslimit", 10000]}; // Preise bitte anpassen!
