...
switch (_side) do {
	...
	case independent: {_query = format["UPDATE players SET name='%1', medcash='%2', medbank='%3', med_licenses='%4', med_gear='%6' WHERE playerid='%5'",_name,_cash,_bank,_licenses,_uid,_gear];};
	case east: {_query = format["UPDATE players SET name='%1', adaccash='%2', adacbank='%3', adac_licenses='%4', adac_gear='%6' WHERE playerid='%5'",_name,_cash,_bank,_licenses,_uid,_gear];};
};
