...
switch (_side) do {
	...
	case east: {_query = format["UPDATE players SET name='%1', adaccash='%2', adacbank='%3', civ_licenses='%4', adac_gear='%6' WHERE playerid='%5'",_name,_cash,_bank,_licenses,_uid,_gear];};
};
