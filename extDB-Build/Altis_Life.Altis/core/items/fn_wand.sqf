...
_wand = "Land_Shoot_House_Wall_F" createVehicle [0,0,0];
...
' _bag = nearestObjects[getPos player,["Land_Shoot_House_Wall_F"],8] select 0; !isNil "_bag" && !isNil {(_bag getVariable "item")}'];