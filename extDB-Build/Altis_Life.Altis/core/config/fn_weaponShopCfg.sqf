			...
			default
			{
				["Mohammed's Jihadi Shop",
					[
						...
						["srifle_GM6_F",nil,7000],
						["srifle_LRR_F",nil,9000],
						["srifle_DMR_01_F",nil,8200],
						["arifle_MXC_F",nil,3000],
						["arifle_MXC_Black_F",nil,3000],
						["arifle_MX_F",nil,2800],
						["arifle_MX_Black_F",nil,2800],
						["arifle_MX_SW_F",nil,3700],
						["arifle_MX_SW_Black_F",nil,3700],
						["arifle_MXM_F",nil,4500],
						["arifle_MXM_Black_F",nil,4500],
						["arifle_Katiba_F",nil,5000],
						["arifle_TRG21_F",nil,6200],
						["arifle_TRG20_F",nil,6200],
						["LMG_Mk200_F",nil,7600],
						["LMG_Zafir_F",nil,86000],
