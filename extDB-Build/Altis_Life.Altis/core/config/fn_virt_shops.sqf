...
switch (_shop) do
{
	case "market": {["Altis Markt",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","schaufel","fuelF","peach","lagerfeuer","zelt","boltcutter","storagesmall","storagebig"]]};
	...
	case "gang": {["Gangmarkt", ["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","lagerfeuer","blastingcharge","boltcutter","camonetz","zelt","wand","kabelb"]]};
