...
if((lbCurSel 2621) == -1) exitWith {hint "Du musst jemanden auswählen, den du entfernen willst!"};
_unit = call compile format["%1",getSelData(2621)];
if(isNull _unit) exitWith {}; //Bad unit?
if(_unit == player) exitWith {hint "Du kannst dich nicht selbst entfernen!"};
