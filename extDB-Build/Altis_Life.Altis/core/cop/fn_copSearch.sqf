...
if(count _invs > 0) then
{
	...
	[[0,format["%1 hat Schmuggelwaren im Wert von $%2 dabei.",(_civ getVariable["realname",name _civ]),[_illegal] call life_fnc_numberText]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
}
	else
{
	_inv = "Nichts illegales gefunden";
};
