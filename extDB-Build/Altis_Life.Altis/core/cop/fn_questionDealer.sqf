...
if(count _sellers == 0) exitWith {hint "Niemand hat bei diesem Dealer etwas verkauft."}; //No data.
...
hint parseText format["Folgende Leute haben vor kurzem hier etwas verkauft.<br/><br/>%1",_names];
