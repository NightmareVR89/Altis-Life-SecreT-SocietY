...
//Atemprüfer
_Btn8 ctrlSetText localize "STR_pInAct_Atempruefer";
_Btn8 buttonSetAction "[[player],""life_fnc_atempruefer"",life_pInact_curTarget,FALSE] spawn life_fnc_MP;closeDialog 0";
