...
if(_num > _value) exitWith {hint "In dem Fahrzeug sind nicht so viele von diesem Gegenstand."};
	...
	else
{
	...
	{
		hint "Konnte nichts in deinem Inventar lagern, bist du voll beladen?";
	};
};