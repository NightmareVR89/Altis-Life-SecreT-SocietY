...
//Create grape zones
{
	...
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Weintrauben = player addAction['Sammle Weintrauben',life_fnc_gatherWeintrauben,'',0,false,false,'','!life_sammel_sperre'];","player removeAction LIFE_Action_Weintrauben;"];
} foreach _grapeZones;