...
switch(_type) do {
	case "0": {
		...
		hint "Du wurdest geblitzt! Hier sind maximal 50 km/h erlaubt und du bist etwas zu schnell gefahren. Du wirst nun gesucht und musst ein Bußgeld bezahlen.";
		sleep 5;
	};
	case "1": {
		[[_driver,"PhotoSound"],"life_fnc_say3D",nil,false] spawn life_fnc_MP;
		[[getPlayerUID _driver,_driver getVariable["realname",name _driver],"1214"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
		hint "Du wurdest geblitzt! Hier sind maximal 50 km/h erlaubt und du bist mehr als 20 km/h zu schnell gefahren. Du wirst nun gesucht und musst ein Bußgeld bezahlen.";
		sleep 5;
	};
	case "2": {
		[[_driver,"PhotoSound"],"life_fnc_say3D",nil,false] spawn life_fnc_MP;
		[[getPlayerUID _driver,_driver getVariable["realname",name _driver],"1215"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
		hint "Du wurdest geblitzt! Hier sind maximal 50 km/h erlaubt und du Raser bist mehr als 50 km/h zu schnell gefahren. Du wirst nun gesucht und musst ein Bußgeld bezahlen.";
		sleep 5;
	};
};