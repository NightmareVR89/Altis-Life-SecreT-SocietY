...
if(isNull _organThief) exitWith {}; //if not the thief get bent
	...
	[[1,format["%1 hat eine Niere bei %2 rausgeschnitten.",name _organThief,name player]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;//lets people know you are stealing kidneys
	[_organThief,"niere",1] call life_fnc_handleInv;//put stolen kidney into inventory of thief
	...
	_organThief setVariable["hatOrgan",false,true];//allow them to be able to take organs again- setting a variable
